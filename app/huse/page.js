...
export default function Huse() {
  ...
  useEffect(() => {
    ...
    const ProductEngine = {
      ...
      getActiveFilters() {
        const filters = { compatibility: [], material: [], features: [] };
      ...
      renderActiveTags() {
        ...
        const f = this.getActiveFilters();
        const allActive = [...f.compatibility, ...f.material, ...f.features];
      ...
      clearAllActiveFilters() {
        ...
        if (DOM.pageTitle) DOM.pageTitle.textContent = 'Huse';
            ...
            <div className="filter-scroll-area">
              ...
              <div className="filter-widget-ultra">
                ...
                <div className="filter-options-ultra" data-filter-group="material">
                  ...
                  <label className="cyber-checkbox-ultra"><input type="checkbox" value="kevlar" /><span className="box-ultra"></span> <span className="lbl-text">Kevlar / Carbon</span></label>
                </div>
              </div>
              <hr className="filter-divider" />
              <div className="filter-widget-ultra">
                <h4 className="widget-title-ultra">Caracteristici</h4>
                <div className="filter-options-ultra" data-filter-group="features">
                  ...
                  <label className="cyber-checkbox-ultra"><input type="checkbox" value="transparent" /><span className="box-ultra"></span> <span className="lbl-text">Transparentă</span></label>
                  <label className="cyber-checkbox-ultra"><input type="checkbox" value="anti-shock" /><span className="box-ultra"></span> <span className="lbl-text">Anti-șoc</span></label>
                </div>
              </div>
            </div>
          </aside>
