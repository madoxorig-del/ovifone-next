...
export default function Admin() {
  ...
  useEffect(() => {
    ...
    window.editeazaProdus = async function(id) {
      ...
      if (document.getElementById('p-categorie-stare')) document.getElementById('p-categorie-stare').value = p.categorie_stare || 'Nou';
    ...
    function resetForm() {
      ...
      if (document.getElementById('p-categorie-stare')) document.getElementById('p-categorie-stare').value = 'Nou';
    ...
    // ── TEMPLATE DESCRIERI (desc = descriere HTML, specs = tabel specificații) ──
    const descTemplates = {
      'iPhone 17 ProMax': { desc: '<h2>Titanium. Mai subțire. Mai puternic.</h2><p>Noul iPhone 17 Pro Max redefinește standardele performanței și ale designului. Construit din titan de calitate aerospațială, este incredibil de robust și totuși uimitor de ușor. Marginile sale ultra-subțiri fac loc celui mai mare și mai imersiv ecran Super Retina XDR creat vreodată de Apple.</p><h3>Cipul A19 Pro. Inteligență fără limite.</h3><p>La inima dispozitivului stă noul cip A19 Pro. Acesta este motorul care susține cele mai complexe funcții de Apple Intelligence, oferind grafică la nivel de consolă pentru gaming și o eficiență energetică uluitoare pentru o baterie care te ține conectat de dimineața până târziu în noapte.</p><h3>Cameră de 48MP. Detalii la un alt nivel.</h3><p>Sistemul foto avansat a fost complet regândit. Echipat cu noul senzor principal de 48MP și o cameră Telephoto cu zoom optic 5x îmbunătățit, iPhone 17 Pro Max îți permite să captezi portrete cinematografice și clipuri video ProRes în 4K la 120 fps.</p>', specs: '<table class="specs-table"><tbody><tr class="spec-header"><td colspan="2">Afișaj</td></tr><tr><td>Tip ecran</td><td>LTPO Super Retina XDR OLED, 120Hz, HDR10, Dolby Vision</td></tr><tr><td>Dimensiune</td><td>6.9 inci</td></tr><tr><td>Rezoluție</td><td>1328 x 2878 pixeli</td></tr><tr><td>Protecție</td><td>Ceramic Shield glass (Gen 3)</td></tr><tr class="spec-header"><td colspan="2">Procesor</td></tr><tr><td>Chipset</td><td>Apple A19 Pro (2 nm)</td></tr><tr><td>CPU</td><td>Hexa-core</td></tr><tr><td>GPU</td><td>Apple GPU (6-core graphics)</td></tr><tr class="spec-header"><td colspan="2">Camere Foto</td></tr><tr><td>Principală</td><td>48 MP, f/1.8, 24mm (wide), dual pixel PDAF, sensor-shift OIS</td></tr><tr><td>Telephoto</td><td>48 MP, f/2.8, 120mm (periscope telephoto), 5x optical zoom</td></tr><tr><td>Ultrawide</td><td>48 MP, f/2.2, 13mm, 120˚, dual pixel PDAF</td></tr><tr><td>Selfie</td><td>24 MP, f/1.9, 23mm (wide), PDAF, OIS</td></tr><tr class="spec-header"><td colspan="2">Conectivitate</td></tr><tr><td>WLAN</td><td>Wi-Fi 802.11 a/b/g/n/ac/6e/7, tri-band</td></tr><tr><td>Bluetooth</td><td>5.4, A2DP, LE</td></tr><tr><td>NFC</td><td>Da</td></tr><tr><td>USB</td><td>USB Type-C 4.0, DisplayPort</td></tr><tr class="spec-header"><td colspan="2">Baterie & Senzori</td></tr><tr><td>Senzori</td><td>Face ID, accelerometru, giroscop, proximitate, busolă, barometru</td></tr><tr><td>Baterie</td><td>Li-Ion 4600 mAh, nedetașabilă</td></tr><tr><td>Încărcare</td><td>Fast charging 50% in 30 min, MagSafe wireless 15W</td></tr></tbody></table>' },
      'iPhone 17 Pro': { desc: '<h2>Pro. Până la ultimul detaliu.</h2><p>iPhone 17 Pro combină designul din titan cu puterea cipului A19 Pro. Ecranul Super Retina XDR de 6.3" cu ProMotion 120Hz oferă o experiență vizuală excepțională, iar camerele pro te ajută să captezi momente imposibile.</p><h3>Cipul A19 Pro. Performanță de elită.</h3><p>A19 Pro aduce Apple Intelligence la un alt nivel, cu o putere grafică remarcabilă și eficiență energetică de top.</p><h3>Sistem foto Pro de 48MP.</h3><p>Camera principală de 48MP, Telephoto cu zoom optic 5x și Ultrawide de 48MP transformă fiecare fotografie într-o operă de artă.</p>', specs: '<table class="specs-table"><tbody><tr class="spec-header"><td colspan="2">Afișaj</td></tr><tr><td>Tip ecran</td><td>LTPO Super Retina XDR OLED, 120Hz, HDR10, Dolby Vision</td></tr><tr><td>Dimensiune</td><td>6.3 inci</td></tr><tr><td>Rezoluție</td><td>1206 x 2622 pixeli</td></tr><tr><td>Protecție</td><td>Ceramic Shield glass (Gen 3)</td></tr><tr class="spec-header"><td colspan="2">Procesor</td></tr><tr><td>Chipset</td><td>Apple A19 Pro (2 nm)</td></tr><tr><td>CPU</td><td>Hexa-core</td></tr><tr><td>GPU</td><td>Apple GPU (6-core graphics)</td></tr><tr class="spec-header"><td colspan="2">Camere Foto</td></tr><tr><td>Principală</td><td>48 MP, f/1.8, 24mm (wide), dual pixel PDAF, sensor-shift OIS</td></tr><tr><td>Telephoto</td><td>48 MP, f/2.8, 120mm (periscope telephoto), 5x optical zoom</td></tr><tr><td>Ultrawide</td><td>48 MP, f/2.2, 13mm, 120˚, dual pixel PDAF</td></tr><tr><td>Selfie</td><td>24 MP, f/1.9, 23mm (wide), PDAF, OIS</td></tr><tr class="spec-header"><td colspan="2">Conectivitate</td></tr><tr><td>WLAN</td><td>Wi-Fi 802.11 a/b/g/n/ac/6e/7, tri-band</td></tr><tr><td>Bluetooth</td><td>5.4, A2DP, LE</td></tr><tr><td>NFC</td><td>Da</td></tr><tr><td>USB</td><td>USB Type-C 4.0, DisplayPort</td></tr><tr class="spec-header"><td colspan="2">Baterie & Senzori</td></tr><tr><td>Senzori</td><td>Face ID, accelerometru, giroscop, proximitate, busolă, barometru</td></tr><tr><td>Baterie</td><td>Li-Ion 4000 mAh, nedetașabilă</td></tr><tr><td>Încărcare</td><td>Fast charging 50% in 30 min, MagSafe wireless 15W</td></tr></tbody></table>' },
      'iPhone 17 Air': { desc: '<h2>Ultraslim. Ultraputernic.</h2><p>iPhone 17 Air este cel mai subțire iPhone creat vreodată. Cu un design incredibil de elegant și ușor, redefinește portabilitatea fără a face compromisuri la performanță sau calitatea camerei.</p><h3>Design care sfidează limitele.</h3><p>Cu doar 5.5mm grosime, iPhone 17 Air este o capodoperă de inginerie.</p><h3>Cameră de 48MP. Simplitate Pro.</h3><p>Camera unică de 48MP cu senzor avansat captează fotografii uimitoare în orice condiții de lumină.</p>', specs: '<table class="specs-table"><tbody><tr class="spec-header"><td colspan="2">Afișaj</td></tr><tr><td>Tip ecran</td><td>Super Retina XDR OLED, 120Hz, HDR10</td></tr><tr><td>Dimensiune</td><td>6.6 inci</td></tr><tr><td>Rezoluție</td><td>1260 x 2740 pixeli</td></tr><tr><td>Protecție</td><td>Ceramic Shield glass</td></tr><tr class="spec-header"><td colspan="2">Procesor</td></tr><tr><td>Chipset</td><td>Apple A19 (2 nm)</td></tr><tr><td>CPU</td><td>Hexa-core</td></tr><tr><td>GPU</td><td>Apple GPU (5-core graphics)</td></tr><tr class="spec-header"><td colspan="2">Camere Foto</td></tr><tr><td>Principală</td><td>48 MP, f/1.6, 28mm (wide), dual pixel PDAF, sensor-shift OIS</td></tr><tr><td>Selfie</td><td>24 MP, f/1.9, 23mm (wide), PDAF</td></tr><tr class="spec-header"><td colspan="2">Conectivitate</td></tr><tr><td>WLAN</td><td>Wi-Fi 802.11 a/b/g/n/ac/6e/7</td></tr><tr><td>Bluetooth</td><td>5.4, A2DP, LE</td></tr><tr><td>NFC</td><td>Da</td></tr><tr><td>USB</td><td>USB Type-C 3.2</td></tr><tr class="spec-header"><td colspan="2">Baterie & Senzori</td></tr><tr><td>Senzori</td><td>Face ID, accelerometru, giroscop, proximitate, busolă</td></tr><tr><td>Baterie</td><td>Li-Ion 3000 mAh, nedetașabilă</td></tr><tr><td>Încărcare</td><td>Fast charging, MagSafe wireless 15W</td></tr></tbody></table>' },
      'iPhone 17': { desc: '<h2>Nou. Îndrăzneț. Incredibil.</h2><p>iPhone 17 aduce cele mai importante inovații Apple într-un format accesibil. Cu Dynamic Island, chipul A19 și o cameră de 48MP, este cel mai bun iPhone pentru majoritatea utilizatorilor.</p><h3>Cipul A19. Putere inteligentă.</h3><p>A19 alimentează funcțiile Apple Intelligence, jocuri avansate și multitasking fluid.</p><h3>Cameră de 48MP. Fotografii extraordinare.</h3><p>Camera Fusion de 48MP captează de două ori mai multe detalii.</p>', specs: '<table class="specs-table"><tbody><tr class="spec-header"><td colspan="2">Afișaj</td></tr><tr><td>Tip ecran</td><td>Super Retina XDR OLED, 60Hz, HDR10</td></tr><tr><td>Dimensiune</td><td>6.1 inci</td></tr><tr><td>Rezoluție</td><td>1170 x 2532 pixeli</td></tr><tr><td>Protecție</td><td>Ceramic Shield glass</td></tr><tr class="spec-header"><td colspan="2">Procesor</td></tr><tr><td>Chipset</td><td>Apple A19 (2 nm)</td></tr><tr><td>CPU</td><td>Hexa-core</td></tr><tr><td>GPU</td><td>Apple GPU (5-core graphics)</td></tr><tr class="spec-header"><td colspan="2">Camere Foto</td></tr><tr><td>Principală</td><td>48 MP, f/1.6, 26mm (wide), dual pixel PDAF, sensor-shift OIS</td></tr><tr><td>Ultrawide</td><td>12 MP, f/2.4, 13mm, 120˚</td></tr><tr><td>Selfie</td><td>12 MP, f/1.9, PDAF</td></tr><tr class="spec-header"><td colspan="2">Conectivitate</td></tr><tr><td>WLAN</td><td>Wi-Fi 802.11 a/b/g/n/ac/6e/7</td></tr><tr><td>Bluetooth</td><td>5.4, A2DP, LE</td></tr><tr><td>NFC</td><td>Da</td></tr><tr><td>USB</td><td>USB Type-C 3.2</td></tr><tr class="spec-header"><td colspan="2">Baterie & Senzori</td></tr><tr><td>Senzori</td><td>Face ID, accelerometru, giroscop, proximitate, busolă</td></tr><tr><td>Baterie</td><td>Li-Ion 3500 mAh, nedetașabilă</td></tr><tr><td>Încărcare</td><td>Fast charging, MagSafe wireless 15W</td></tr></tbody></table>' },
      'iPhone 16 ProMax': { desc: '<h2>Cel mai mare. Cel mai avansat.</h2><p>iPhone 16 Pro Max vine cu cel mai mare ecran de pe un iPhone — 6.9" Super Retina XDR. Chipul A18 Pro și Camera Control îl transformă într-un studio foto profesional de buzunar.</p><h3>A18 Pro. Putere de generație nouă.</h3><p>Cipul A18 Pro oferă performanțe grafice cu 20% mai rapide față de generația anterioară.</p><h3>Camera de 48MP cu zoom 5x Tetraprism.</h3><p>Noul sistem de camere cu senzor Fusion de 48MP și Telephoto cu zoom optic 5x Tetraprism captează imagini incredibile.</p>', specs: '<table class="specs-table"><tbody><tr class="spec-header"><td colspan="2">Afișaj</td></tr><tr><td>Tip ecran</td><td>LTPO Super Retina XDR OLED, 120Hz, HDR10, Dolby Vision</td></tr><tr><td>Dimensiune</td><td>6.9 inci</td></tr><tr><td>Rezoluție</td><td>1320 x 2868 pixeli</td></tr><tr><td>Protecție</td><td>Ceramic Shield glass (Gen 2)</td></tr><tr class="spec-header"><td colspan="2">Procesor</td></tr><tr><td>Chipset</td><td>Apple A18 Pro (3 nm)</td></tr><tr><td>CPU</td><td>Hexa-core</td></tr><tr><td>GPU</td><td>Apple GPU (6-core graphics)</td></tr><tr class="spec-header"><td colspan="2">Camere Foto</td></tr><tr><td>Principală</td><td>48 MP, f/1.78, 24mm (wide), dual pixel PDAF, sensor-shift OIS</td></tr><tr><td>Telephoto</td><td>12 MP, f/2.8, 120mm (periscope telephoto), 5x optical zoom</td></tr><tr><td>Ultrawide</td><td>48 MP, f/2.2, 13mm, 120˚</td></tr><tr><td>Selfie</td><td>12 MP, f/1.9, 23mm, PDAF</td></tr><tr class="spec-header"><td colspan="2">Conectivitate</td></tr><tr><td>WLAN</td><td>Wi-Fi 802.11 a/b/g/n/ac/6e/7</td></tr><tr><td>Bluetooth</td><td>5.3, A2DP, LE</td></tr><tr><td>NFC</td><td>Da</td></tr><tr><td>USB</td><td>USB Type-C 3.0, DisplayPort</td></tr><tr class="spec-header"><td colspan="2">Baterie & Senzori</td></tr><tr><td>Senzori</td><td>Face ID, accelerometru, giroscop, proximitate, busolă, barometru</td></tr><tr><td>Baterie</td><td>Li-Ion 4685 mAh, nedetașabilă</td></tr><tr><td>Încărcare</td><td>Fast charging 50% in 30 min, MagSafe wireless 15W</td></tr></tbody></table>' },
      'iPhone 16 Pro': { desc: '<h2>Pro. Fără compromisuri.</h2><p>iPhone 16 Pro ridică ștacheta cu ecranul Super Retina XDR de 6.3" și chipul A18 Pro. Camera Control oferă acces instant la funcțiile foto.</p><h3>A18 Pro. Motor de inovație.</h3><p>Cu performanțe GPU cu 20% mai rapide, A18 Pro alimentează Apple Intelligence și ray tracing avansat.</p><h3>Sistem Pro de camere.</h3><p>Camera Fusion de 48MP, Ultrawide de 48MP și Telephoto cu zoom optic 5x te ajută să captezi orice scenă.</p>', specs: '<table class="specs-table"><tbody><tr class="spec-header"><td colspan="2">Afișaj</td></tr><tr><td>Tip ecran</td><td>LTPO Super Retina XDR OLED, 120Hz, HDR10, Dolby Vision</td></tr><tr><td>Dimensiune</td><td>6.3 inci</td></tr><tr><td>Rezoluție</td><td>1206 x 2622 pixeli</td></tr><tr><td>Protecție</td><td>Ceramic Shield glass (Gen 2)</td></tr><tr class="spec-header"><td colspan="2">Procesor</td></tr><tr><td>Chipset</td><td>Apple A18 Pro (3 nm)</td></tr><tr><td>CPU</td><td>Hexa-core</td></tr><tr><td>GPU</td><td>Apple GPU (6-core graphics)</td></tr><tr class="spec-header"><td colspan="2">Camere Foto</td></tr><tr><td>Principală</td><td>48 MP, f/1.78, 24mm (wide), dual pixel PDAF, sensor-shift OIS</td></tr><tr><td>Telephoto</td><td>12 MP, f/2.8, 120mm (periscope telephoto), 5x optical zoom</td></tr><tr><td>Ultrawide</td><td>48 MP, f/2.2, 13mm, 120˚</td></tr><tr><td>Selfie</td><td>12 MP, f/1.9, 23mm, PDAF</td></tr><tr class="spec-header"><td colspan="2">Conectivitate</td></tr><tr><td>WLAN</td><td>Wi-Fi 802.11 a/b/g/n/ac/6e/7</td></tr><tr><td>Bluetooth</td><td>5.3, A2DP, LE</td></tr><tr><td>NFC</td><td>Da</td></tr><tr><td>USB</td><td>USB Type-C 3.0, DisplayPort</td></tr><tr class="spec-header"><td colspan="2">Baterie & Senzori</td></tr><tr><td>Senzori</td><td>Face ID, accelerometru, giroscop, proximitate, busolă, barometru</td></tr><tr><td>Baterie</td><td>Li-Ion 3582 mAh, nedetașabilă</td></tr><tr><td>Încărcare</td><td>Fast charging 50% in 30 min, MagSafe wireless 15W</td></tr></tbody></table>' },
      'iPhone 16': { desc: '<h2>Bun venit în era inteligenței.</h2><p>iPhone 16 aduce Apple Intelligence pentru toți. Cu chipul A18 și Camera Control, ai cele mai puternice funcții Apple la un preț accesibil.</p><h3>A18. Rapid. Eficient. Inteligent.</h3><p>Noul cip A18 oferă performanțe cu 30% mai rapide decât A16 Bionic, cu un Neural Engine de 16 nuclee.</p><h3>Cameră Fusion de 48MP.</h3><p>Camera principală de 48MP cu senzor quad-pixel oferă fotografii excepționale.</p>', specs: '<table class="specs-table"><tbody><tr class="spec-header"><td colspan="2">Afișaj</td></tr><tr><td>Tip ecran</td><td>Super Retina XDR OLED, 60Hz, HDR10, Dolby Vision</td></tr><tr><td>Dimensiune</td><td>6.1 inci</td></tr><tr><td>Rezoluție</td><td>1179 x 2556 pixeli</td></tr><tr><td>Protecție</td><td>Ceramic Shield glass (Gen 2)</td></tr><tr class="spec-header"><td colspan="2">Procesor</td></tr><tr><td>Chipset</td><td>Apple A18 (3 nm)</td></tr><tr><td>CPU</td><td>Hexa-core</td></tr><tr><td>GPU</td><td>Apple GPU (5-core graphics)</td></tr><tr class="spec-header"><td colspan="2">Camere Foto</td></tr><tr><td>Principală</td><td>48 MP, f/1.6, 26mm (wide), dual pixel PDAF, sensor-shift OIS</td></tr><tr><td>Ultrawide</td><td>12 MP, f/2.2, 13mm, 120˚</td></tr><tr><td>Selfie</td><td>12 MP, f/1.9, PDAF</td></tr><tr class="spec-header"><td colspan="2">Conectivitate</td></tr><tr><td>WLAN</td><td>Wi-Fi 802.11 a/b/g/n/ac/6e/7</td></tr><tr><td>Bluetooth</td><td>5.3, A2DP, LE</td></tr><tr><td>NFC</td><td>Da</td></tr><tr><td>USB</td><td>USB Type-C 2.0</td></tr><tr class="spec-header"><td colspan="2">Baterie & Senzori</td></tr><tr><td>Senzori</td><td>Face ID, accelerometru, giroscop, proximitate, busolă</td></tr><tr><td>Baterie</td><td>Li-Ion 3561 mAh, nedetașabilă</td></tr><tr><td>Încărcare</td><td>Fast charging, MagSafe wireless 15W</td></tr></tbody></table>' },
      'iPhone 15 ProMax': { desc: '<h2>Titan. Forjat în perfecțiune.</h2><p>iPhone 15 Pro Max, primul iPhone din titan, este cel mai ușor și mai rezistent model Pro. Ecranul de 6.7" și chipul A17 Pro oferă o experiență fără egal.</p><h3>A17 Pro. Primul cip de 3nm.</h3><p>Chipul A17 Pro aduce GPU cu ray tracing accelerat hardware, transformând iPhone-ul într-o consolă de gaming portabilă.</p><h3>Cameră cu zoom 5x Tetraprism.</h3><p>Pentru prima dată pe iPhone, zoom optic 5x cu design tetraprism. Camera principală de 48MP captează detalii incredibile.</p>', specs: '<table class="specs-table"><tbody><tr class="spec-header"><td colspan="2">Afișaj</td></tr><tr><td>Tip ecran</td><td>LTPO Super Retina XDR OLED, 120Hz, HDR10, Dolby Vision</td></tr><tr><td>Dimensiune</td><td>6.7 inci</td></tr><tr><td>Rezoluție</td><td>1290 x 2796 pixeli</td></tr><tr><td>Protecție</td><td>Ceramic Shield glass</td></tr><tr class="spec-header"><td colspan="2">Procesor</td></tr><tr><td>Chipset</td><td>Apple A17 Pro (3 nm)</td></tr><tr><td>CPU</td><td>Hexa-core</td></tr><tr><td>GPU</td><td>Apple GPU (6-core graphics)</td></tr><tr class="spec-header"><td colspan="2">Camere Foto</td></tr><tr><td>Principală</td><td>48 MP, f/1.78, 24mm (wide), dual pixel PDAF, sensor-shift OIS</td></tr><tr><td>Telephoto</td><td>12 MP, f/2.8, 120mm (periscope telephoto), 5x optical zoom</td></tr><tr><td>Ultrawide</td><td>12 MP, f/2.2, 13mm, 120˚, dual pixel PDAF</td></tr><tr><td>Selfie</td><td>12 MP, f/1.9, PDAF</td></tr><tr class="spec-header"><td colspan="2">Conectivitate</td></tr><tr><td>WLAN</td><td>Wi-Fi 802.11 a/b/g/n/ac/6e</td></tr><tr><td>Bluetooth</td><td>5.3, A2DP, LE</td></tr><tr><td>NFC</td><td>Da</td></tr><tr><td>USB</td><td>USB Type-C 3.0, DisplayPort</td></tr><tr class="spec-header"><td colspan="2">Baterie & Senzori</td></tr><tr><td>Senzori</td><td>Face ID, accelerometru, giroscop, proximitate, busolă, barometru</td></tr><tr><td>Baterie</td><td>Li-Ion 4441 mAh, nedetașabilă</td></tr><tr><td>Încărcare</td><td>Fast charging 50% in 35 min, MagSafe wireless 15W</td></tr></tbody></table>' },
      'iPhone 15 Pro': { desc: '<h2>Pro. Forjat din titan.</h2><p>iPhone 15 Pro introduce designul din titan și butonul Action personalizabil. Cu A17 Pro și USB-C, este un salt generațional.</p><h3>A17 Pro. Putere revoluționară.</h3><p>Primul cip de 3nm. GPU cu ray tracing hardware și performanțe CPU cu 10% mai rapide.</p><h3>Sistem foto Pro de 48MP.</h3><p>Camera principală de 48MP, Telephoto 3x și Ultrawide oferă versatilitate totală.</p>', specs: '<table class="specs-table"><tbody><tr class="spec-header"><td colspan="2">Afișaj</td></tr><tr><td>Tip ecran</td><td>LTPO Super Retina XDR OLED, 120Hz, HDR10, Dolby Vision</td></tr><tr><td>Dimensiune</td><td>6.1 inci</td></tr><tr><td>Rezoluție</td><td>1179 x 2556 pixeli</td></tr><tr><td>Protecție</td><td>Ceramic Shield glass</td></tr><tr class="spec-header"><td colspan="2">Procesor</td></tr><tr><td>Chipset</td><td>Apple A17 Pro (3 nm)</td></tr><tr><td>CPU</td><td>Hexa-core</td></tr><tr><td>GPU</td><td>Apple GPU (6-core graphics)</td></tr><tr class="spec-header"><td colspan="2">Camere Foto</td></tr><tr><td>Principală</td><td>48 MP, f/1.78, 24mm (wide), dual pixel PDAF, sensor-shift OIS</td></tr><tr><td>Telephoto</td><td>12 MP, f/2.8, 77mm, PDAF, OIS, 3x optical zoom</td></tr><tr><td>Ultrawide</td><td>12 MP, f/2.2, 13mm, 120˚, dual pixel PDAF</td></tr><tr><td>Selfie</td><td>12 MP, f/1.9, PDAF</td></tr><tr class="spec-header"><td colspan="2">Conectivitate</td></tr><tr><td>WLAN</td><td>Wi-Fi 802.11 a/b/g/n/ac/6e</td></tr><tr><td>Bluetooth</td><td>5.3, A2DP, LE</td></tr><tr><td>NFC</td><td>Da</td></tr><tr><td>USB</td><td>USB Type-C 3.0, DisplayPort</td></tr><tr class="spec-header"><td colspan="2">Baterie & Senzori</td></tr><tr><td>Senzori</td><td>Face ID, accelerometru, giroscop, proximitate, busolă, barometru</td></tr><tr><td>Baterie</td><td>Li-Ion 3274 mAh, nedetașabilă</td></tr><tr><td>Încărcare</td><td>Fast charging 50% in 35 min, MagSafe wireless 15W</td></tr></tbody></table>' },
      'iPhone 15': { desc: '<h2>Nou. Dinamic. Uimitor.</h2><p>iPhone 15 aduce Dynamic Island, camera de 48MP și USB-C într-un pachet colorat și accesibil.</p><h3>Dynamic Island. Interacțiuni la alt nivel.</h3><p>Dynamic Island transformă notificările într-o experiență intuitivă și elegantă.</p><h3>Cameră de 48MP.</h3><p>Senzorul de 48MP cu quad-pixel oferă fotografii la rezoluție de 24MP cu detalii remarcabile.</p>', specs: '<table class="specs-table"><tbody><tr class="spec-header"><td colspan="2">Afișaj</td></tr><tr><td>Tip ecran</td><td>Super Retina XDR OLED, 60Hz, HDR10, Dolby Vision</td></tr><tr><td>Dimensiune</td><td>6.1 inci</td></tr><tr><td>Rezoluție</td><td>1179 x 2556 pixeli</td></tr><tr><td>Protecție</td><td>Ceramic Shield glass</td></tr><tr class="spec-header"><td colspan="2">Procesor</td></tr><tr><td>Chipset</td><td>Apple A16 Bionic (4 nm)</td></tr><tr><td>CPU</td><td>Hexa-core</td></tr><tr><td>GPU</td><td>Apple GPU (5-core graphics)</td></tr><tr class="spec-header"><td colspan="2">Camere Foto</td></tr><tr><td>Principală</td><td>48 MP, f/1.6, 26mm (wide), dual pixel PDAF, sensor-shift OIS</td></tr><tr><td>Ultrawide</td><td>12 MP, f/2.4, 13mm, 120˚</td></tr><tr><td>Selfie</td><td>12 MP, f/1.9, PDAF</td></tr><tr class="spec-header"><td colspan="2">Conectivitate</td></tr><tr><td>WLAN</td><td>Wi-Fi 802.11 a/b/g/n/ac/6e</td></tr><tr><td>Bluetooth</td><td>5.3, A2DP, LE</td></tr><tr><td>NFC</td><td>Da</td></tr><tr><td>USB</td><td>USB Type-C 2.0</td></tr><tr class="spec-header"><td colspan="2">Baterie & Senzori</td></tr><tr><td>Senzori</td><td>Face ID, accelerometru, giroscop, proximitate, busolă</td></tr><tr><td>Baterie</td><td>Li-Ion 3349 mAh, nedetașabilă</td></tr><tr><td>Încărcare</td><td>Fast charging 50% in 30 min, MagSafe wireless 15W</td></tr></tbody></table>' },
      'iPhone 14 ProMax': { desc: '<h2>Always-On. Always Amazing.</h2><p>iPhone 14 Pro Max introduce ecranul Always-On și Dynamic Island — două inovații care schimbă fundamental interacțiunea cu telefonul.</p><h3>Dynamic Island.</h3><p>Transformă pilula camerei frontale într-un element interactiv fluid.</p><h3>Cameră de 48MP.</h3><p>Senzorul principal de 48MP quad-pixel captează de 4 ori mai multe informații. Photonic Engine îmbunătățește fotografiile în lumină scăzută.</p>', specs: '<table class="specs-table"><tbody><tr class="spec-header"><td colspan="2">Afișaj</td></tr><tr><td>Tip ecran</td><td>LTPO Super Retina XDR OLED, 120Hz, Always-On, HDR10, Dolby Vision</td></tr><tr><td>Dimensiune</td><td>6.7 inci</td></tr><tr><td>Rezoluție</td><td>1290 x 2796 pixeli</td></tr><tr><td>Protecție</td><td>Ceramic Shield glass</td></tr><tr class="spec-header"><td colspan="2">Procesor</td></tr><tr><td>Chipset</td><td>Apple A16 Bionic (4 nm)</td></tr><tr><td>CPU</td><td>Hexa-core</td></tr><tr><td>GPU</td><td>Apple GPU (5-core graphics)</td></tr><tr class="spec-header"><td colspan="2">Camere Foto</td></tr><tr><td>Principală</td><td>48 MP, f/1.78, 24mm (wide), dual pixel PDAF, sensor-shift OIS</td></tr><tr><td>Telephoto</td><td>12 MP, f/2.8, 77mm, PDAF, OIS, 3x optical zoom</td></tr><tr><td>Ultrawide</td><td>12 MP, f/2.2, 13mm, 120˚, dual pixel PDAF</td></tr><tr><td>Selfie</td><td>12 MP, f/1.9, PDAF</td></tr><tr class="spec-header"><td colspan="2">Conectivitate</td></tr><tr><td>WLAN</td><td>Wi-Fi 802.11 a/b/g/n/ac/6e</td></tr><tr><td>Bluetooth</td><td>5.3, A2DP, LE</td></tr><tr><td>NFC</td><td>Da</td></tr><tr><td>USB</td><td>Lightning, USB 2.0</td></tr><tr class="spec-header"><td colspan="2">Baterie & Senzori</td></tr><tr><td>Senzori</td><td>Face ID, accelerometru, giroscop, proximitate, busolă, barometru</td></tr><tr><td>Baterie</td><td>Li-Ion 4323 mAh, nedetașabilă</td></tr><tr><td>Încărcare</td><td>Fast charging 50% in 35 min, MagSafe wireless 15W</td></tr></tbody></table>' },
      'iPhone 14 Pro': { desc: '<h2>Pro. Și mai Pro.</h2><p>iPhone 14 Pro transformă experiența smartphone cu Dynamic Island și ecranul Always-On.</p><h3>Ecran Always-On.</h3><p>Afișează permanent ora, widgeturile și notificările fără consum semnificativ de baterie.</p><h3>48MP. Cel mai mare upgrade foto.</h3><p>Saltul de la 12MP la 48MP aduce un nivel de detaliu fără precedent.</p>', specs: '<table class="specs-table"><tbody><tr class="spec-header"><td colspan="2">Afișaj</td></tr><tr><td>Tip ecran</td><td>LTPO Super Retina XDR OLED, 120Hz, Always-On, HDR10, Dolby Vision</td></tr><tr><td>Dimensiune</td><td>6.1 inci</td></tr><tr><td>Rezoluție</td><td>1179 x 2556 pixeli</td></tr><tr><td>Protecție</td><td>Ceramic Shield glass</td></tr><tr class="spec-header"><td colspan="2">Procesor</td></tr><tr><td>Chipset</td><td>Apple A16 Bionic (4 nm)</td></tr><tr><td>CPU</td><td>Hexa-core</td></tr><tr><td>GPU</td><td>Apple GPU (5-core graphics)</td></tr><tr class="spec-header"><td colspan="2">Camere Foto</td></tr><tr><td>Principală</td><td>48 MP, f/1.78, 24mm (wide), dual pixel PDAF, sensor-shift OIS</td></tr><tr><td>Telephoto</td><td>12 MP, f/2.8, 77mm, PDAF, OIS, 3x optical zoom</td></tr><tr><td>Ultrawide</td><td>12 MP, f/2.2, 13mm, 120˚, dual pixel PDAF</td></tr><tr><td>Selfie</td><td>12 MP, f/1.9, PDAF</td></tr><tr class="spec-header"><td colspan="2">Conectivitate</td></tr><tr><td>WLAN</td><td>Wi-Fi 802.11 a/b/g/n/ac/6e</td></tr><tr><td>Bluetooth</td><td>5.3, A2DP, LE</td></tr><tr><td>NFC</td><td>Da</td></tr><tr><td>USB</td><td>Lightning, USB 2.0</td></tr><tr class="spec-header"><td colspan="2">Baterie & Senzori</td></tr><tr><td>Senzori</td><td>Face ID, accelerometru, giroscop, proximitate, busolă, barometru</td></tr><tr><td>Baterie</td><td>Li-Ion 3200 mAh, nedetașabilă</td></tr><tr><td>Încărcare</td><td>Fast charging 50% in 35 min, MagSafe wireless 15W</td></tr></tbody></table>' },
      'iPhone 14': { desc: '<h2>Simplu genial.</h2><p>iPhone 14 oferă performanțe excelente cu chipul A15 Bionic și funcții de siguranță revoluționare precum Crash Detection și Emergency SOS via satelit.</p><h3>A15 Bionic. Încă incredibil de rapid.</h3><p>Cu GPU de 5 nuclee, A15 Bionic oferă performanțe grafice cu 18% mai rapide.</p><h3>Cameră duală îmbunătățită.</h3><p>Senzorul principal de 12MP cu pixeli mai mari captează cu 49% mai multă lumină.</p>', specs: '<table class="specs-table"><tbody><tr class="spec-header"><td colspan="2">Afișaj</td></tr><tr><td>Tip ecran</td><td>Super Retina XDR OLED, 60Hz, HDR10, Dolby Vision</td></tr><tr><td>Dimensiune</td><td>6.1 inci</td></tr><tr><td>Rezoluție</td><td>1170 x 2532 pixeli</td></tr><tr><td>Protecție</td><td>Ceramic Shield glass</td></tr><tr class="spec-header"><td colspan="2">Procesor</td></tr><tr><td>Chipset</td><td>Apple A15 Bionic (5 nm)</td></tr><tr><td>CPU</td><td>Hexa-core</td></tr><tr><td>GPU</td><td>Apple GPU (5-core graphics)</td></tr><tr class="spec-header"><td colspan="2">Camere Foto</td></tr><tr><td>Principală</td><td>12 MP, f/1.5, 26mm (wide), dual pixel PDAF, sensor-shift OIS</td></tr><tr><td>Ultrawide</td><td>12 MP, f/2.4, 13mm, 120˚</td></tr><tr><td>Selfie</td><td>12 MP, f/1.9, PDAF</td></tr><tr class="spec-header"><td colspan="2">Conectivitate</td></tr><tr><td>WLAN</td><td>Wi-Fi 802.11 a/b/g/n/ac/6</td></tr><tr><td>Bluetooth</td><td>5.3, A2DP, LE</td></tr><tr><td>NFC</td><td>Da</td></tr><tr><td>USB</td><td>Lightning, USB 2.0</td></tr><tr class="spec-header"><td colspan="2">Baterie & Senzori</td></tr><tr><td>Senzori</td><td>Face ID, accelerometru, giroscop, proximitate, busolă</td></tr><tr><td>Baterie</td><td>Li-Ion 3279 mAh, nedetașabilă</td></tr><tr><td>Încărcare</td><td>Fast charging 50% in 30 min, MagSafe wireless 15W</td></tr></tbody></table>' },
      'iPhone 13 ProMax': { desc: '<h2>Cea mai mare autonomie de pe un iPhone.</h2><p>iPhone 13 Pro Max oferă bateria cea mai mare din istoria iPhone. Ecranul ProMotion 120Hz și sistemul de camere cinematografice îl fac un flagship complet.</p><h3>ProMotion 120Hz.</h3><p>Rată adaptivă de refresh de la 10Hz la 120Hz pentru animații ultra-fluide.</p><h3>Cinematic Mode.</h3><p>Filmează cu schimbarea automată a focusului între subiecți, exact ca într-un film profesional.</p>', specs: '<table class="specs-table"><tbody><tr class="spec-header"><td colspan="2">Afișaj</td></tr><tr><td>Tip ecran</td><td>LTPO Super Retina XDR OLED, 120Hz, HDR10, Dolby Vision</td></tr><tr><td>Dimensiune</td><td>6.7 inci</td></tr><tr><td>Rezoluție</td><td>1284 x 2778 pixeli</td></tr><tr><td>Protecție</td><td>Ceramic Shield glass</td></tr><tr class="spec-header"><td colspan="2">Procesor</td></tr><tr><td>Chipset</td><td>Apple A15 Bionic (5 nm)</td></tr><tr><td>CPU</td><td>Hexa-core</td></tr><tr><td>GPU</td><td>Apple GPU (5-core graphics)</td></tr><tr class="spec-header"><td colspan="2">Camere Foto</td></tr><tr><td>Principală</td><td>12 MP, f/1.5, 26mm (wide), dual pixel PDAF, sensor-shift OIS</td></tr><tr><td>Telephoto</td><td>12 MP, f/2.8, 77mm, PDAF, OIS, 3x optical zoom</td></tr><tr><td>Ultrawide</td><td>12 MP, f/1.8, 13mm, 120˚, dual pixel PDAF</td></tr><tr><td>Selfie</td><td>12 MP, f/2.2</td></tr><tr class="spec-header"><td colspan="2">Conectivitate</td></tr><tr><td>WLAN</td><td>Wi-Fi 802.11 a/b/g/n/ac/6</td></tr><tr><td>Bluetooth</td><td>5.0, A2DP, LE</td></tr><tr><td>NFC</td><td>Da</td></tr><tr><td>USB</td><td>Lightning, USB 2.0</td></tr><tr class="spec-header"><td colspan="2">Baterie & Senzori</td></tr><tr><td>Senzori</td><td>Face ID, accelerometru, giroscop, proximitate, busolă, barometru</td></tr><tr><td>Baterie</td><td>Li-Ion 4352 mAh, nedetașabilă</td></tr><tr><td>Încărcare</td><td>Fast charging 50% in 35 min, MagSafe wireless 15W</td></tr></tbody></table>' },
      'iPhone 13 Pro': { desc: '<h2>Oh. Atât de Pro.</h2><p>iPhone 13 Pro aduce ProMotion 120Hz, Cinematic Mode și un sistem de camere complet regândit.</p><h3>ProMotion. Răspuns instant.</h3><p>Ecranul cu rată adaptivă de refresh până la 120Hz face totul mai fluid.</p><h3>Macro Photography. O premieră pe iPhone.</h3><p>Camera Ultrawide cu autofocus permite fotografii macro la doar 2cm distanță.</p>', specs: '<table class="specs-table"><tbody><tr class="spec-header"><td colspan="2">Afișaj</td></tr><tr><td>Tip ecran</td><td>LTPO Super Retina XDR OLED, 120Hz, HDR10, Dolby Vision</td></tr><tr><td>Dimensiune</td><td>6.1 inci</td></tr><tr><td>Rezoluție</td><td>1170 x 2532 pixeli</td></tr><tr><td>Protecție</td><td>Ceramic Shield glass</td></tr><tr class="spec-header"><td colspan="2">Procesor</td></tr><tr><td>Chipset</td><td>Apple A15 Bionic (5 nm)</td></tr><tr><td>CPU</td><td>Hexa-core</td></tr><tr><td>GPU</td><td>Apple GPU (5-core graphics)</td></tr><tr class="spec-header"><td colspan="2">Camere Foto</td></tr><tr><td>Principală</td><td>12 MP, f/1.5, 26mm (wide), dual pixel PDAF, sensor-shift OIS</td></tr><tr><td>Telephoto</td><td>12 MP, f/2.8, 77mm, PDAF, OIS, 3x optical zoom</td></tr><tr><td>Ultrawide</td><td>12 MP, f/1.8, 13mm, 120˚, dual pixel PDAF, macro</td></tr><tr><td>Selfie</td><td>12 MP, f/2.2</td></tr><tr class="spec-header"><td colspan="2">Conectivitate</td></tr><tr><td>WLAN</td><td>Wi-Fi 802.11 a/b/g/n/ac/6</td></tr><tr><td>Bluetooth</td><td>5.0, A2DP, LE</td></tr><tr><td>NFC</td><td>Da</td></tr><tr><td>USB</td><td>Lightning, USB 2.0</td></tr><tr class="spec-header"><td colspan="2">Baterie & Senzori</td></tr><tr><td>Senzori</td><td>Face ID, accelerometru, giroscop, proximitate, busolă, barometru</td></tr><tr><td>Baterie</td><td>Li-Ion 3095 mAh, nedetașabilă</td></tr><tr><td>Încărcare</td><td>Fast charging 50% in 30 min, MagSafe wireless 15W</td></tr></tbody></table>' },
      'iPhone 13': { desc: '<h2>Superputere la tine în buzunar.</h2><p>iPhone 13 vine cu chipul A15 Bionic, cameră duală cu Cinematic Mode și cea mai bună autonomie de pe un iPhone de 6.1".</p><h3>A15 Bionic. Rapid peste măsură.</h3><p>Cel mai rapid chip din orice smartphone, face totul mai fluid.</p><h3>Cinematic Mode.</h3><p>Cinematic Mode schimbă automat focusul între subiecți, creând un efect de profunzime cinematografic.</p>', specs: '<table class="specs-table"><tbody><tr class="spec-header"><td colspan="2">Afișaj</td></tr><tr><td>Tip ecran</td><td>Super Retina XDR OLED, 60Hz, HDR10, Dolby Vision</td></tr><tr><td>Dimensiune</td><td>6.1 inci</td></tr><tr><td>Rezoluție</td><td>1170 x 2532 pixeli</td></tr><tr><td>Protecție</td><td>Ceramic Shield glass</td></tr><tr class="spec-header"><td colspan="2">Procesor</td></tr><tr><td>Chipset</td><td>Apple A15 Bionic (5 nm)</td></tr><tr><td>CPU</td><td>Hexa-core</td></tr><tr><td>GPU</td><td>Apple GPU (4-core graphics)</td></tr><tr class="spec-header"><td colspan="2">Camere Foto</td></tr><tr><td>Principală</td><td>12 MP, f/1.6, 26mm (wide), dual pixel PDAF, sensor-shift OIS</td></tr><tr><td>Ultrawide</td><td>12 MP, f/2.4, 13mm, 120˚</td></tr><tr><td>Selfie</td><td>12 MP, f/2.2</td></tr><tr class="spec-header"><td colspan="2">Conectivitate</td></tr><tr><td>WLAN</td><td>Wi-Fi 802.11 a/b/g/n/ac/6</td></tr><tr><td>Bluetooth</td><td>5.0, A2DP, LE</td></tr><tr><td>NFC</td><td>Da</td></tr><tr><td>USB</td><td>Lightning, USB 2.0</td></tr><tr class="spec-header"><td colspan="2">Baterie & Senzori</td></tr><tr><td>Senzori</td><td>Face ID, accelerometru, giroscop, proximitate, busolă</td></tr><tr><td>Baterie</td><td>Li-Ion 3227 mAh, nedetașabilă</td></tr><tr><td>Încărcare</td><td>Fast charging 50% in 30 min, MagSafe wireless 15W</td></tr></tbody></table>' },
      'Samsung S25 Ultra': { desc: '<h2>Galaxy AI. Putere Ultra.</h2><p>Galaxy S25 Ultra este cel mai puternic smartphone Samsung, construit din titan cu Snapdragon 8 Elite și Galaxy AI integrat. Camera de 200MP și S Pen-ul încorporat îl fac instrumentul suprem.</p><h3>Snapdragon 8 Elite. Performanță fără rival.</h3><p>Performanțe cu 40% mai rapide în AI, grafică la nivel de consolă.</p><h3>Cameră de 200MP. Detalii ultra.</h3><p>Zoom optic 5x și Space Zoom 100x îți permit să surprinzi orice subiect.</p>', specs: '<table class="specs-table"><tbody><tr class="spec-header"><td colspan="2">Afișaj</td></tr><tr><td>Tip ecran</td><td>Dynamic AMOLED 2X, 120Hz, HDR10+, Vision Booster</td></tr><tr><td>Dimensiune</td><td>6.9 inci</td></tr><tr><td>Rezoluție</td><td>1440 x 3120 pixeli (QHD+)</td></tr><tr><td>Protecție</td><td>Corning Gorilla Armor 2</td></tr><tr class="spec-header"><td colspan="2">Procesor</td></tr><tr><td>Chipset</td><td>Snapdragon 8 Elite (3 nm)</td></tr><tr><td>CPU</td><td>Octa-core (2x4.47 GHz + 6x3.53 GHz)</td></tr><tr><td>GPU</td><td>Adreno 830</td></tr><tr class="spec-header"><td colspan="2">Camere Foto</td></tr><tr><td>Principală</td><td>200 MP, f/1.7, 23mm (wide), PDAF, OIS</td></tr><tr><td>Telephoto</td><td>50 MP, f/3.4, 111mm (periscope), 5x optical zoom</td></tr><tr><td>Telephoto 2</td><td>10 MP, f/2.4, 67mm, 3x optical zoom</td></tr><tr><td>Ultrawide</td><td>12 MP, f/2.2, 13mm, 120˚</td></tr><tr><td>Selfie</td><td>12 MP, f/2.2, 26mm, dual pixel PDAF</td></tr><tr class="spec-header"><td colspan="2">Conectivitate</td></tr><tr><td>WLAN</td><td>Wi-Fi 802.11 a/b/g/n/ac/6e/7</td></tr><tr><td>Bluetooth</td><td>5.4, A2DP, LE</td></tr><tr><td>NFC</td><td>Da</td></tr><tr><td>USB</td><td>USB Type-C 3.2, DisplayPort</td></tr><tr class="spec-header"><td colspan="2">Baterie & Senzori</td></tr><tr><td>Senzori</td><td>Fingerprint (ultrasonic, in-display), accelerometru, giroscop, proximitate, busolă, barometru</td></tr><tr><td>Baterie</td><td>Li-Ion 5000 mAh, nedetașabilă</td></tr><tr><td>Încărcare</td><td>Fast charging 45W, wireless 15W, reverse wireless</td></tr><tr><td>S Pen</td><td>Da, integrat</td></tr></tbody></table>' },
      'Samsung S25+': { desc: '<h2>Galaxy AI. Plus de putere.</h2><p>Galaxy S25+ combină ecranul mare Dynamic AMOLED 2X de 6.7" cu puterea Snapdragon 8 Elite și Galaxy AI.</p><h3>Galaxy AI. Asistent inteligent.</h3><p>Traduceri în timp real, rezumate inteligente, editare foto cu AI generativ și Circle to Search.</p><h3>Cameră triplă de 50MP.</h3><p>Camera principală de 50MP cu Nightography produce fotografii clare în orice condiții.</p>', specs: '<table class="specs-table"><tbody><tr class="spec-header"><td colspan="2">Afișaj</td></tr><tr><td>Tip ecran</td><td>Dynamic AMOLED 2X, 120Hz, HDR10+, Vision Booster</td></tr><tr><td>Dimensiune</td><td>6.7 inci</td></tr><tr><td>Rezoluție</td><td>1440 x 3120 pixeli (QHD+)</td></tr><tr><td>Protecție</td><td>Corning Gorilla Victus 2</td></tr><tr class="spec-header"><td colspan="2">Procesor</td></tr><tr><td>Chipset</td><td>Snapdragon 8 Elite (3 nm)</td></tr><tr><td>CPU</td><td>Octa-core</td></tr><tr><td>GPU</td><td>Adreno 830</td></tr><tr class="spec-header"><td colspan="2">Camere Foto</td></tr><tr><td>Principală</td><td>50 MP, f/1.8, 24mm (wide), dual pixel PDAF, OIS</td></tr><tr><td>Telephoto</td><td>10 MP, f/2.4, 67mm, 3x optical zoom</td></tr><tr><td>Ultrawide</td><td>12 MP, f/2.2, 13mm, 120˚</td></tr><tr><td>Selfie</td><td>12 MP, f/2.2, 26mm, dual pixel PDAF</td></tr><tr class="spec-header"><td colspan="2">Conectivitate</td></tr><tr><td>WLAN</td><td>Wi-Fi 802.11 a/b/g/n/ac/6e/7</td></tr><tr><td>Bluetooth</td><td>5.4, A2DP, LE</td></tr><tr><td>NFC</td><td>Da</td></tr><tr><td>USB</td><td>USB Type-C 3.2</td></tr><tr class="spec-header"><td colspan="2">Baterie & Senzori</td></tr><tr><td>Senzori</td><td>Fingerprint (ultrasonic, in-display), accelerometru, giroscop, proximitate, busolă</td></tr><tr><td>Baterie</td><td>Li-Ion 4900 mAh, nedetașabilă</td></tr><tr><td>Încărcare</td><td>Fast charging 45W, wireless 15W, reverse wireless</td></tr></tbody></table>' },
      'Samsung S25': { desc: '<h2>Galaxy AI. Compact. Complet.</h2><p>Galaxy S25 aduce toată puterea Snapdragon 8 Elite și Galaxy AI într-un format compact de 6.2".</p><h3>Compact, dar puternic.</h3><p>Același Snapdragon 8 Elite fără compromisuri la performanță. Galaxy AI complet funcțional.</p><h3>Cameră de 50MP cu Nightography.</h3><p>Fotografii detaliate ziua și noaptea. AI optimizează automat fiecare cadru.</p>', specs: '<table class="specs-table"><tbody><tr class="spec-header"><td colspan="2">Afișaj</td></tr><tr><td>Tip ecran</td><td>Dynamic AMOLED 2X, 120Hz, HDR10+, Vision Booster</td></tr><tr><td>Dimensiune</td><td>6.2 inci</td></tr><tr><td>Rezoluție</td><td>1080 x 2340 pixeli (FHD+)</td></tr><tr><td>Protecție</td><td>Corning Gorilla Victus 2</td></tr><tr class="spec-header"><td colspan="2">Procesor</td></tr><tr><td>Chipset</td><td>Snapdragon 8 Elite (3 nm)</td></tr><tr><td>CPU</td><td>Octa-core</td></tr><tr><td>GPU</td><td>Adreno 830</td></tr><tr class="spec-header"><td colspan="2">Camere Foto</td></tr><tr><td>Principală</td><td>50 MP, f/1.8, 24mm (wide), dual pixel PDAF, OIS</td></tr><tr><td>Telephoto</td><td>10 MP, f/2.4, 67mm, 3x optical zoom</td></tr><tr><td>Ultrawide</td><td>12 MP, f/2.2, 13mm, 120˚</td></tr><tr><td>Selfie</td><td>12 MP, f/2.2, 26mm, dual pixel PDAF</td></tr><tr class="spec-header"><td colspan="2">Conectivitate</td></tr><tr><td>WLAN</td><td>Wi-Fi 802.11 a/b/g/n/ac/6e/7</td></tr><tr><td>Bluetooth</td><td>5.4, A2DP, LE</td></tr><tr><td>NFC</td><td>Da</td></tr><tr><td>USB</td><td>USB Type-C 3.2</td></tr><tr class="spec-header"><td colspan="2">Baterie & Senzori</td></tr><tr><td>Senzori</td><td>Fingerprint (ultrasonic, in-display), accelerometru, giroscop, proximitate, busolă</td></tr><tr><td>Baterie</td><td>Li-Ion 4000 mAh, nedetașabilă</td></tr><tr><td>Încărcare</td><td>Fast charging 25W, wireless 15W, reverse wireless</td></tr></tbody></table>' },
      'Samsung S24 Ultra': { desc: '<h2>Galaxy AI. Experiența supremă.</h2><p>Galaxy S24 Ultra este primul smartphone cu Galaxy AI nativ. Cadru din titan, cameră de 200MP și S Pen.</p><h3>Galaxy AI. Revoluția inteligenței.</h3><p>Traducere live a apelurilor, Circle to Search, Chat Assist și Generative Edit.</p><h3>200MP și Nightography.</h3><p>Zoom optic 5x și Space Zoom 100x aduc orice subiect aproape.</p>', specs: '<table class="specs-table"><tbody><tr class="spec-header"><td colspan="2">Afișaj</td></tr><tr><td>Tip ecran</td><td>Dynamic AMOLED 2X, 120Hz, HDR10+, Vision Booster</td></tr><tr><td>Dimensiune</td><td>6.8 inci</td></tr><tr><td>Rezoluție</td><td>1440 x 3088 pixeli (QHD+)</td></tr><tr><td>Protecție</td><td>Corning Gorilla Armor</td></tr><tr class="spec-header"><td colspan="2">Procesor</td></tr><tr><td>Chipset</td><td>Snapdragon 8 Gen 3 (4 nm)</td></tr><tr><td>CPU</td><td>Octa-core</td></tr><tr><td>GPU</td><td>Adreno 750</td></tr><tr class="spec-header"><td colspan="2">Camere Foto</td></tr><tr><td>Principală</td><td>200 MP, f/1.7, 23mm (wide), PDAF, OIS</td></tr><tr><td>Telephoto</td><td>50 MP, f/3.4, 111mm (periscope), 5x optical zoom</td></tr><tr><td>Telephoto 2</td><td>10 MP, f/2.4, 67mm, 3x optical zoom</td></tr><tr><td>Ultrawide</td><td>12 MP, f/2.2, 13mm, 120˚</td></tr><tr><td>Selfie</td><td>12 MP, f/2.2, 26mm, dual pixel PDAF</td></tr><tr class="spec-header"><td colspan="2">Conectivitate</td></tr><tr><td>WLAN</td><td>Wi-Fi 802.11 a/b/g/n/ac/6e/7</td></tr><tr><td>Bluetooth</td><td>5.3, A2DP, LE</td></tr><tr><td>NFC</td><td>Da</td></tr><tr><td>USB</td><td>USB Type-C 3.2, DisplayPort</td></tr><tr class="spec-header"><td colspan="2">Baterie & Senzori</td></tr><tr><td>Senzori</td><td>Fingerprint (ultrasonic, in-display), accelerometru, giroscop, proximitate, busolă, barometru</td></tr><tr><td>Baterie</td><td>Li-Ion 5000 mAh, nedetașabilă</td></tr><tr><td>Încărcare</td><td>Fast charging 45W, wireless 15W, reverse wireless</td></tr><tr><td>S Pen</td><td>Da, integrat</td></tr></tbody></table>' },
      'Samsung S24': { desc: '<h2>Galaxy AI. Smart și elegant.</h2><p>Galaxy S24 introduce Galaxy AI într-un format compact de 6.2". Procesor puternic, cameră triplă de 50MP și ecran Dynamic AMOLED 2X.</p><h3>Galaxy AI accesibil.</h3><p>Live Translate, Circle to Search, Chat Assist și editare foto generativă.</p><h3>Cameră triplă de 50MP.</h3><p>Nightography produce fotografii naturale și detaliate. Zoom optic 3x și Ultrawide acoperă orice scenariu.</p>', specs: '<table class="specs-table"><tbody><tr class="spec-header"><td colspan="2">Afișaj</td></tr><tr><td>Tip ecran</td><td>Dynamic AMOLED 2X, 120Hz, HDR10+, Vision Booster</td></tr><tr><td>Dimensiune</td><td>6.2 inci</td></tr><tr><td>Rezoluție</td><td>1080 x 2340 pixeli (FHD+)</td></tr><tr><td>Protecție</td><td>Corning Gorilla Victus 2</td></tr><tr class="spec-header"><td colspan="2">Procesor</td></tr><tr><td>Chipset</td><td>Exynos 2400 (4 nm)</td></tr><tr><td>CPU</td><td>Deca-core</td></tr><tr><td>GPU</td><td>Xclipse 940</td></tr><tr class="spec-header"><td colspan="2">Camere Foto</td></tr><tr><td>Principală</td><td>50 MP, f/1.8, 24mm (wide), dual pixel PDAF, OIS</td></tr><tr><td>Telephoto</td><td>10 MP, f/2.4, 67mm, 3x optical zoom</td></tr><tr><td>Ultrawide</td><td>12 MP, f/2.2, 13mm, 120˚</td></tr><tr><td>Selfie</td><td>12 MP, f/2.2, 26mm, dual pixel PDAF</td></tr><tr class="spec-header"><td colspan="2">Conectivitate</td></tr><tr><td>WLAN</td><td>Wi-Fi 802.11 a/b/g/n/ac/6e</td></tr><tr><td>Bluetooth</td><td>5.3, A2DP, LE</td></tr><tr><td>NFC</td><td>Da</td></tr><tr><td>USB</td><td>USB Type-C 2.0</td></tr><tr class="spec-header"><td colspan="2">Baterie & Senzori</td></tr><tr><td>Senzori</td><td>Fingerprint (ultrasonic, in-display), accelerometru, giroscop, proximitate, busolă</td></tr><tr><td>Baterie</td><td>Li-Ion 4000 mAh, nedetașabilă</td></tr><tr><td>Încărcare</td><td>Fast charging 25W, wireless 15W, reverse wireless</td></tr></tbody></table>' },
      'Samsung S25 FE': { desc: '<h2>Galaxy AI. Tot ce contează.</h2><p>Galaxy S25 FE aduce cele mai importante funcții Galaxy AI și o cameră excelentă la un preț accesibil.</p><h3>Fan Edition. Fără compromisuri majore.</h3><p>Galaxy AI complet — Circle to Search, Live Translate, Generative Edit și Note Assist.</p><h3>Cameră triplă performantă.</h3><p>Camera principală de 50MP cu Nightography și stabilizare optică produce fotografii clare.</p>', specs: '<table class="specs-table"><tbody><tr class="spec-header"><td colspan="2">Afișaj</td></tr><tr><td>Tip ecran</td><td>Dynamic AMOLED 2X, 120Hz, HDR10+</td></tr><tr><td>Dimensiune</td><td>6.7 inci</td></tr><tr><td>Rezoluție</td><td>1080 x 2340 pixeli (FHD+)</td></tr><tr><td>Protecție</td><td>Corning Gorilla Victus+</td></tr><tr class="spec-header"><td colspan="2">Procesor</td></tr><tr><td>Chipset</td><td>Exynos 2400e (4 nm)</td></tr><tr><td>CPU</td><td>Deca-core</td></tr><tr><td>GPU</td><td>Xclipse 940</td></tr><tr class="spec-header"><td colspan="2">Camere Foto</td></tr><tr><td>Principală</td><td>50 MP, f/1.8, 24mm (wide), dual pixel PDAF, OIS</td></tr><tr><td>Telephoto</td><td>8 MP, f/2.4, 75mm, 3x optical zoom</td></tr><tr><td>Ultrawide</td><td>12 MP, f/2.2, 13mm, 123˚</td></tr><tr><td>Selfie</td><td>10 MP, f/2.4</td></tr><tr class="spec-header"><td colspan="2">Conectivitate</td></tr><tr><td>WLAN</td><td>Wi-Fi 802.11 a/b/g/n/ac/6e</td></tr><tr><td>Bluetooth</td><td>5.3, A2DP, LE</td></tr><tr><td>NFC</td><td>Da</td></tr><tr><td>USB</td><td>USB Type-C 2.0</td></tr><tr class="spec-header"><td colspan="2">Baterie & Senzori</td></tr><tr><td>Senzori</td><td>Fingerprint (optical, in-display), accelerometru, giroscop, proximitate, busolă</td></tr><tr><td>Baterie</td><td>Li-Ion 4500 mAh, nedetașabilă</td></tr><tr><td>Încărcare</td><td>Fast charging 25W, wireless 15W, reverse wireless</td></tr></tbody></table>' }
    };
    document.getElementById('btn-apply-template')?.addEventListener('click', () => {
      ...
      const tpl = sel?.value ? descTemplates[sel.value] : null;
      if (tpl && desc) {
        desc.value = tpl.desc;
      ...
      if (tpl && specs) {
        specs.value = tpl.specs;
        specs.style.transition = 'box-shadow 0.3s ease';
        specs.style.boxShadow = '0 0 0 2px var(--accent)';
        setTimeout(() => { specs.style.boxShadow = ''; }, 1500);
      }
    });
    ...
    document.getElementById('btn-upload')?.addEventListener('click', async () => {
      ...
      try {
        ...
        if (cat === 'telefoane' || cat === 'telefoane altele' || cat === 'tablete') { productData.stocare = document.getElementById('p-storage')?.value || null; productData.baterie = document.getElementById('p-baterie')?.value || null; productData.stare = document.getElementById('p-stare')?.value || null; productData.categorie_stare = document.getElementById('p-categorie-stare')?.value || null; }
          ...
          <div id="panel-adaugare" className="panel">
            ...
            <div style={{ background: 'var(--glass-bg)', backdropFilter: 'var(--glass-blur)', WebkitBackdropFilter: 'var(--glass-blur)', border: '1px solid var(--glass-border)', borderRadius: 'var(--radius)', boxShadow: 'var(--glass-shadow)', padding: '32px' }}>
              ...
              <div id="grup-specific-tech">
                ...
                <div className="form-grid">
                  <div className="field"><label>Categorie</label><select id="p-categorie-stare"><option value="Nou">Nou</option><option value="SH">Second Hand (SH)</option></select></div>
                  <div className="field"><label>Stare Vizuală</label><select id="p-stare"><option value="Nou">Nou Sigilat</option><option value="Excelent">Excelent</option><option value="Foarte Bun">Foarte Bun</option><option value="Bun">Bun</option></select></div>
                </div>
              </div>
